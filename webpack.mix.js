...
if (COMPILE == 'admin' || COMPILE == 'all') {
    ...
    mix.styles([
        ...
        // plugins
        pathCSS + 'vendor/select2-v4.0.3.min.css',
   ...
   //     pathCSS + 'vendor/summernote.css',
    ...
    mix.scripts([
        ...
        pathJS + 'vendor/select2-v4.0.3.min.js',
        pathJS + 'vendor/select2-v4.0.3-fr.min.js',
      ...
      //  pathJS + 'vendor/summernote.js',
        ...
        pathJS + 'vendor/moment-locale-fr.js',
        ...
        pathJS + 'vendor/jquery.slugify.js',
        ...
        // admin
        pathJS + 'admin-lte.js'//,
    //    ,pathJS + 'admin-scripts.js' // Déplacé et Mis directement dans le layout pour pouvoir faire des modif
