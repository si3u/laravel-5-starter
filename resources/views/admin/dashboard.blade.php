...
$(function() {
	$('li:not(ul.dropdown-menu li)', 'ul#list-link-to-website').addClass('bold btn btn-default').removeClass('active');
	$('ul#list-link-to-website a').attr('target', '_blank');
});
</script>
@endsection
    ...
    <div class="well well-sm bg-gray-light">
        <div class="row">
            <div class="col-md-5 margin-bottom">
                ...
                <ul class="list-unstyled btn-group">
                    <p style="margin-top: 5px; margin-bottom: 0;">
                        <i class="fa fa-linux"></i> <strong> A voir :</strong>
                    </p>
					<br/>
					
                    <li class="btn btn-default">
                        <a href="/admin/latest-activity/website"><strong>Activités Site</strong></a>
					</li>
                    <li class="btn btn-default">
                        <a href="/admin/latest-activity/website"><strong>Activités Administration</strong></a>
					</li>
                    <li class="btn btn-default">
                        <a href="/admin/profile"><strong>Profil</strong></a>
					</li>
            ...
            <div class="col-md-7 margin-bottom">
                ...
                <ul id="list-link-to-website" class="list-unstyled list-inline btn-group">
					
                    <p style="margin-top: 5px; margin-bottom: 0;">
                        <i class="fa fa-link"></i> <strong> Liens vers le site :</strong>
                    </p>
					<br/>
					
					{!! $websiteDashboardNavigation !!}
