            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        <span>{{ isset($item)? 'Modifier la ' . $item->title : 'Entrer une nouvelle rue' }}</span>
                    </h3>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ form_error_class('city_id', $errors) }}">
                                    	...
                                    	{!! form_select('city_id', ([0 => 'Sélectionner une ville'] + $cities), ($errors && $errors->any()? old('city_id') : (isset($item)? $item->city_id : '')), ['class' => 'select2 form-control']) !!}
