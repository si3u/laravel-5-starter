                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ form_error_class('roles', $errors) }}">
                                        ...
                                        {!! form_select('roles[]', $roles, ($errors && $errors->any()? old('roles') : (isset($item)? $item->roles->pluck('id')->all() : '')), ['class' => 'select2 select2notags', 'multiple']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col col-5">
                                    <section class="form-group {{ form_error_class('parent_id', $errors) }}">
                                        ...
                                        {!! form_select('parent_id', ([0 => 'Please select a Parent'] + $parents), isset($item)? ($errors && $errors->any()? old('parent_id') : $item->parent_id) : old('parent_id'), ['class' => 'select2 select2notags']) !!}
                                ...
                                <div class="col col-5">
                                    <section class="form-group {{ form_error_class('url_parent_id', $errors) }}">
                                        <label for="id-parent_id">Url Parent (parent that will be
                                            ...
                                            empty)</label>
                                        {!! form_select('url_parent_id', ([0 => 'Please select a Url Parent'] + $parents), ($errors && $errors->any()? old('url_parent_id') : (isset($item)? $item->url_parent_id : '')), ['class' => 'select2 select2notags']) !!}
