            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        <span>Mettre à jour : {{ ucfirst($resource) }} Administration</span>
                    </h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="well well-sm well-toolbar" id="nestable-menu">
                        ...
                        <button type="button" class="btn btn-labeled btn-default text-primary" data-action="expand-all">
                            <span class="btn-label"><i class="fa fa-fw fa-plus-circle"></i></span>Tout Ouvrir
                        </button>

                        <button type="button" class="btn btn-labeled btn-default text-primary" data-action="collapse-all">
                            <span class="btn-label"><i class="fa fa-fw fa-minus-circle text-red"></i></span>Tout Fermer
                        </button>
                    </div>
