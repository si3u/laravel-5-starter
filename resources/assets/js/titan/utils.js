...
function doAjax(url, data, callback, loader)
{
    ...
    $.ajax({
        ...
        {
			console.log('Erreur de requête XHR sur : '+url);
            console.log(x);
//            console.log(t);
//            console.log(m);
            notifyError('Pardon', 'Une erreur système s\'est produite.<br>Veuillez réessayer ou contactez notre centre d\'appels.');
        },
...
function isAjaxResponseValid(response)
{
    if (!(response.success || response.data)) {
        notifyError('Pardon', 'Une erreur s\'est produite.<br>Veuillez réessayer.');
        return false;
    }
